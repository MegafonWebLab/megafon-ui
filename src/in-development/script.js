...
const FIRST_CLICK_CLASS = 'interesting-dialog__cat--first-click';
const SECOND_CLICK_CLASS = 'interesting-dialog__cat--second-click';
const FINALLY_CLICK_CLASS = 'interesting-dialog__cat--finally';
