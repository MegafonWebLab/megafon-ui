...
import { video as videoBannerVideo, imageMobile as videoBannerImage } from '../../VideoBanner/doc/VideoBanner.docz.tsx';
...
import {
    text as storeBannerText,
    title as storeBannerTitle,
    image as storeBannerImage
} from '../../StoreBanner/doc/StoreBanner.docz.tsx';
...
<Playground>
    <Container>
        <VideoBanner videoType='video' videoSrc={videoBannerVideo} imageMobile={videoBannerImage} imageTablet={videoBannerImage} />
    </Container>
    <Container>
        <TitleDescriptionBox
            title="Интернет"
