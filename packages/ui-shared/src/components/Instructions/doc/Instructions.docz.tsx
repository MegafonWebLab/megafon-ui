...
const instructionTitles = [
    'Авторизуйтесь на сайте сервиса <b>special.megafon.ru</b>, перейдите в магазин и добавьте покупки в корзину',
    'Выберите любой <a href="https://moscow.megafon.ru/tariffs/all/" target="_blank">тариф</a> из линейки тарифов «Включайся!», которым хотите пользоваться со скидкой 50% на абонентскую плату.',
