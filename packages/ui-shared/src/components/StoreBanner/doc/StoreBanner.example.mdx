...
import { title, text, htmlTitle, htmlText, image, qrCode, newIphoneImage, iphone12Screen, link, onClick } from './StoreBanner.docz.tsx';
...
<Playground>
    <ContentArea>
        <StoreBanner
            ...
            linkGoogle={link}
            onClickGoogle={onClick}
            imageSrc={iphone12Screen}
            deviceMask="iphone-12"
        />
    </ContentArea>
</Playground>
