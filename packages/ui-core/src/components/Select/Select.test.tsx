...
const cn: (param1?: string) => string = cnCreate('mfui-beta-select');
...
describe('<Select />', () => {
    ...
    describe('onSelect', () => {
        ...
        it('calls onSelect after update with new prop items', () => {
            ...
            lastListItem.simulate('mouseenter', { preventDefault: () => jest.fn() });
    ...
    describe('onOpened and onClosed', () => {
        ...
        it('calls onOpened when keyDown Enter with focus', () => {
            ...
            wrapper.find(`.${cn('control')}`).simulate('keyDown', { key: 'Enter', preventDefault: () => jest.fn() });
            expect(handleOpened).toBeCalled();
        });
    });
    ...
    describe('keyboard actions', () => {
        it('handles ArrowUp and ArrowDown', () => {
            ...
            control.simulate('keyDown', { key: 'ArrowDown', preventDefault: () => jest.fn() });
            ...
            control.simulate('keyDown', { key: 'ArrowUp', preventDefault: () => jest.fn() });
            expect(wrapper.find(listItem).at(0).hasClass(listItemActive)).toEqual(true);
            expect(wrapper.find(listItem).at(1).hasClass(listItemActive)).toEqual(false);
        });
        ...
        it('handles Tab', () => {
            ...
            control.simulate('keyDown', { key: 'Tab', preventDefault: () => jest.fn() });
            expect(wrapper).toMatchSnapshot();
        });
        ...
        it('handles Enter with focus to open items list', () => {
            ...
            control.simulate('keyDown', { key: 'Enter', preventDefault: () => jest.fn() });
