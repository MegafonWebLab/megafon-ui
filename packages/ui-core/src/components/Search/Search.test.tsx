...
const cn: (param1?: string) => string = cnCreate('mfui-beta-search');
...
describe('<Search />', () => {
    ...
    describe('keyboard actions', () => {
        it('handles ArrowUp and ArrowDown correctly', () => {
            ...
            searchField.simulate('keyDown', { key: 'ArrowDown', preventDefault: () => jest.fn });
            ...
            searchField.simulate('keyDown', { key: 'ArrowUp', preventDefault: () => jest.fn });
            expect(wrapper.find(listItem).at(0).hasClass(listItemActive)).toEqual(true);
