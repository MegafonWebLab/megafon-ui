...
const cn: (param1?: Record<string, unknown> | string, param2?: (string | undefined)[] | string | undefined) => string =
    cnCreate('mfui-beta-button');
const Button: React.FC<IButtonProps> = ({
    ...
    const setRelAttribute = (): string | undefined => {
        if (ElementType !== 'a') {
            return undefined;
        }
