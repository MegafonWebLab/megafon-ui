...
<Playground style={wrapperDefaultWidthStyle}>
    <TextField name="name" placeholder="password" type="password" isControlled={false}/>
</Playground>

## Обязательное поле

<Playground style={wrapperDefaultWidthStyle}>
    <TextField name="name" required label="Телефон" isControlled={false}/>
</Playground>
...
<Playground style={wrapperDefaultWidthStyle}>
    <DemoTextFieldWithBeforeMaskChangeValue>
        {({ handleBeforeMaskChange }) =>
            <TextField onBeforeMaskChange={handleBeforeMaskChange} mask="+7 (999) 999-99-99" maskchar="_" isControlled={false}/>
        }
    </DemoTextFieldWithBeforeMaskChangeValue>
</Playground>
...
<Playground style={wrapperDefaultWidthStyle}>
    <TextField noticeText="Comment" isControlled={false}/>
</Playground>
...
<Playground style={wrapperWideWidthStyle}>
    <TextField
        ...
        isControlled={false}
    />
    <TextField verification="valid" noticeText="You can write that field value is correct" isControlled={false}/>
</Playground>
...
<Playground style={wrapperDefaultWidthStyle}>
    <TextField maxLength={10} isControlled={false}/>
</Playground>

## Недоступное взаимодействие с компонентом

<Playground style={wrapperDefaultWidthStyle}>
    <TextField disabled={true} isControlled={false}/>
</Playground>

## Внешнее состояние

<Playground style={wrapperDefaultWidthStyle}>
    <TextField initialValue='initial value' isControlled={false} />
</Playground>
...
<Playground style={wrapperDefaultWidthStyle}>
    <TextField name="name" textarea placeholder="placeholder" isControlled={false}/>
</Playground>
...
<Playground style={wrapperDefaultWidthStyle}>
    <TextField name="name" textarea="flexible" isControlled={false}/>
</Playground>
...
<Playground style={wrapperWideWidthStyle}>
    <TextField symbolCounter={10} textarea initialValue="Иванов Ива" isControlled={false}/>
    <TextField symbolCounter={10} textarea initialValue="Иванов Иван Иванович" isControlled={false}/>
</Playground>
