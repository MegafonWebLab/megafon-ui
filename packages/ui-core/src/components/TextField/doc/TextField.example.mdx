...
<Playground style={wrapperWideWidthStyle}>
    <TextField symbolCounter={10} textarea value="Иванов Ива" isControlled={false}/>
    <TextField symbolCounter={10} textarea value="Иванов Иван Иванович" isControlled={false}/>
</Playground>
