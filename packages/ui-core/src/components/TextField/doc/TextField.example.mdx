...
<Playground>
    <TextFieldWrapper>
        <TextField name="name" multiline placeholder="Multiline" maxLength={10} />
    </TextFieldWrapper>
</Playground>
...
<Playground>
    <TextFieldWrapper>
        <TextField name="name" multiline multilineType="flexible" placeholder="Multiline" />
    </TextFieldWrapper>
</Playground>
...
## Превышение заданного ограничения по вводу символов

<Playground>
    <TextFieldWrapper>
        <TextField maxLength={10} multiline value="Иванов Иван Иванович" />
    </TextFieldWrapper>
</Playground>
