...
import ArrowLeft from '@megafon/ui-icons/dist/system-16-arrow-list_left_16.svg';
import ArrowRight from '@megafon/ui-icons/dist/system-16-arrow-list_right_16.svg';
import './Month.less';
