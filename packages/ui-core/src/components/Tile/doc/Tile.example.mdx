...
<Playground>
    <DemoTileWrapper wrapperTheme="dark">
        ...
        <Tile shadowLevel="low" theme="dark">
            <div style={tileInnerWhite}>Low shadow</div>
        </Tile>
        <Tile shadowLevel="high" theme="dark">
            <div style={tileInnerWhite}>High shadow</div>
        </Tile>
    ...
    <DemoTileWrapper wrapperTheme="dark">
        ...
        <Tile radius="rounded" shadowLevel="low">
            <div style={tileInnerWhiteRounded}>Low shadow</div>
        </Tile>
        <Tile radius="rounded" shadowLevel="high">
            <div style={tileInnerWhiteRounded}>High shadow</div>
        </Tile>
